...
{
    public static class ReservationOutboxSingletonDatabase
    {
        static IDbConnection _connection;
        static bool _dataReaderState = true;

        static ReservationOutboxSingletonDatabase() =>
            _connection = new NpgsqlConnection("User ID=postgres;Password=123456;Host=localhost;Port=5432;Database=ReservationExampleReservationDB;");
